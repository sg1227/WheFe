									...
									<div class="modal-dialog modal-sm">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-default btn-md"
													data-toggle="modal"
													data-target="#category-name-edit-complete">카테고리 이름
													수정</button>
												<!--카테고리 추가 완료-->
								...
								<div class="modal fade" id="category-delete" role="dialog">
									<div class="modal-dialog modal-sm">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-default btn-md"
													data-toggle="modal" data-target="#category-delete-complete">삭제하기</button>
												<!--카테고리 삭제 완료-->
...
<body>
    ...
    <div class="container" style="margin-top:80px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4><b>메뉴 관리 (카테고리)<h4></b>
     </div>

<div class="container">
    <div class="row">
      <div class="panel-body">
        <button type="button" class="btn btn-default btn-round-lg btn-lg" data-toggle="modal" data-target="#addCategory" style="border:0; text-align:left">
        ...
        <div class="modal fade" id="addCategory" role="dialog">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <input class="form-control" style="max-width: 270px" name="category-name" placeholder="카테고리 이름" type="text" required autofocus />
                    </div>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#addCategory_complete">카테고리 추가</button>
                <!--카테고리 추가 완료-->
                <div class="modal" id="addCategory_complete" role="dialog">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
    ...
    <div class="row" id="menu">
        <div class="panel-body">
          ...
          <h4><b>Coffee</b></h4>
                ...
                <div class="col-lg-2">
                    <button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#category-name-edit"><span style="margin-right: 5px" class="glyphicon glyphicon-pencil"></span>이름 수정</button>
                    <!--카테고리 이름수정하기 팝업-->
                    <div class="modal fade" id="category-name-edit" role="dialog">
                        <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#category-name-edit-complete">카테고리 이름 수정</button>
                            <!--카테고리 추가 완료-->
                ...
                <div class="col-lg-2">
                    <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#category-delete"><span style="margin-right: 5px" class="glyphicon glyphicon-trash"></span>삭제</button>
                    <!--카테고리 삭제하기 팝업-->
                    <div class="modal fade" id="category-delete" role="dialog">
                        <div class="modal-dialog modal-sm">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#category-delete-complete">삭제하기</button>
                            <!--카테고리 삭제 완료-->
                            <div class="modal" id="category-delete-complete" role="dialog">
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row" style="text-align:center">
